...
import shiva from "../public/shiva.jpeg"

const Cover = () => {
    return ( 
        <div className={`w-full h-40 object-cover bg-cover`} >
        <div className="w-full h-full backdrop-blur-lg justify-between items-center flex px-5 lg:px-12">
          ...
          <Link href={"https://instagram.com/shivay1256"} target="_blank" className="flex gap-2 bg-secondaryBackground md:py-2 p-2 md:px-4 rounded-lg  justify-center items-center">
            <Instagram size={20}/> 
            <p className="max-lg:hidden text-sm font-semibold">Follow me on Instagram</p>
          </Link>
        </div>
      </div>
     );
